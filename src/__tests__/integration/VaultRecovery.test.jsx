...
describe('Vault Recovery Integration', () => {
  ...
  describe('Password Recovery Flow', () => {
    it('should allow recovery with previous password after password change', async () => {
      ...
      const createResult = await window.electronAPI.createVault(
        vaultName,
        originalPassword
      );
      ...
      const recoveryResult =
        await window.electronAPI.recoverVaultWithOldPassword(
          vaultName,
          originalPassword
        );
  ...
  describe('Recovery Scenarios', () => {
    it('should handle multiple password changes correctly', async () => {
      ...
      await window.electronAPI.changeMasterPassword(
        vaultName,
        password1,
        password2
      );
