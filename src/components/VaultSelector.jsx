    ...
    <div className="vault-container">
      <div className="vault-header">
        <Typography variant="h3" className="vault-title">
          <SecurityIcon sx={{ fontSize: '3rem', mr: 2, verticalAlign: 'middle' }} />
          Secure Vault
        </Typography>
                  ...
                  <Typography variant="h6" className="vault-item-name">
                    ...
                    {vault === 'default' && (
                      <Tooltip title="Default Vault">
                        <StarIcon sx={{ ml: 1, fontSize: '1rem', color: '#ffc107' }} />
                      </Tooltip>
                    )}
                  </Typography>
                  <Typography variant="body2" className="vault-item-info">
                    {vault === 'default' ? 'Your default password vault' : 'Custom vault'}
                  </Typography>
                </Box>
