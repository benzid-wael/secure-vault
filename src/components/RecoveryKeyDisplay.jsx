        ...
        <Box sx={{ mb: 3 }}>
          ...
          >
            ...
            <Typography variant="body2">
              • This key can be used to recover your vault if you forget your
              master password • Store it separately from your vault (not on the
              same device) • Anyone with this key can access your vault • You
              cannot recover this key if lost
            </Typography>
          </Alert>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Box
              component="ul"
              sx={{ color: 'rgba(255, 255, 255, 0.7)', pl: 2, m: 0 }}
            >
